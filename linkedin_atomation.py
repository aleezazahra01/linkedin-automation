...
class LinkedinAutomation:
    ...
    def job_search(self):
        ...
        job_btn = self.driver.find_element(By.XPATH, "//svg[@id='job-medium']")
        job_btn.click()
        ...
        # Wait for filter bar
        WebDriverWait(self.driver, 10).until(
            EC.presence_of_element_located((By.XPATH, '//*[@id="search-reusables__filters-bar"]'))
        )

        # Click on Easy Apply filter
        easy_apply = self.driver.find_element(By.XPATH, '//*[@id="searchFilter_applyWithLinkedin"]')
        easy_apply.click()
        time.sleep(5)
...
# Replace broken XPATHs with better locators later
# Add GUI later
